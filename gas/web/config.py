...
class Config(object):  
  ...
  AWS_S3_KEY_PREFIX = "txzheng/"
  AWS_S3_ACL = "private"
  AWS_S3_ENCRYPTION = "AES256"
  RESULTS_SUFFIX = "annot"
  LOG_SUFFIX = ".count.log"

  AWS_GLACIER_VAULT = "ucmpcs"

  # Change the ARNs below to reflect your SNS topics
  AWS_SNS_JOB_REQUEST_TOPIC = \
    "arn:aws:sns:us-east-1:127134666975:txzheng_job_requests"
  AWS_SNS_JOB_COMPLETE_TOPIC = \
    "arn:aws:sns:us-east-1:127134666975:txzheng_job_results"
  AWS_SNS_RESTORE_TOPIC = \
    "arn:aws:sns:us-east-1:127134666975:txzheng_restore"
  AWS_SNS_THAW_TOPIC = \
    "arn:aws:sns:us-east-1:127134666975:txzheng_thaw"
  # Change the table name to your own
  AWS_DYNAMODB_ANNOTATIONS_TABLE = "txzheng_annotations"

  # Change the email address to your username
  MAIL_DEFAULT_SENDER = "txzheng@ucmpcs.org"
